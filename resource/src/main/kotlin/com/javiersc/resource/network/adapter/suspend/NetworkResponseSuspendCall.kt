    ...
    override fun enqueue(callback: Callback<NetworkResponse<R, E>>) = synchronized(this) {
        backingCall.enqueue(object : Callback<R> {
            ...
            override fun onFailure(call: Call<R>, throwable: Throwable) {
                when (throwable) {
                    is ConnectException -> callback.onResponse(
                        this@NetworkResponseSuspendCall,
                    ...
                    is IOException -> callback.onResponse(
                        this@NetworkResponseSuspendCall,
                        Response.success(NetworkResponse.InternetNotAvailable(throwable))
                    )
                    ...
                    is HttpException -> throwable.httpExceptionSuspendHandler(
                        errorConverter,
                        this@NetworkResponseSuspendCall,
                        callback
                    )
