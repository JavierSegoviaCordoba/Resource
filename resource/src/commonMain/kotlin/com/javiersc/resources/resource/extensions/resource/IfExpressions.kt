 ...
 */
public inline fun <reified R, reified E> Resource<R, E>.ifLoading(block: () -> Unit) {
 ...
 */
public inline fun <reified R, reified E> Resource<R, E>.ifNoLoading(block: () -> Unit) {
    if (this !is Resource.Loading) block()
}
 ...
 */
public inline fun <reified R, reified E> Resource<R, E>.ifSuccess(block: (R) -> Unit) {
 ...
 */
public inline fun <reified R, reified E> Resource<R, E>.ifNoSuccess(block: () -> Unit) {
 ...
 */
public inline fun <reified R, reified E> Resource<R, E>.ifError(block: (E) -> Unit) {
 ...
 */
public inline fun <reified R, reified E> Resource<R, E>.ifNoError(block: () -> Unit) {
